 ...
 *
 * Phase 2 mapping:
 * - Tools: BullMQ now retries one chunk at a time.
 * - Orchestrator: this processor handles the queue lifecycle and delegates
 *   domain state transitions to AnalysisExecutionService.
...
export class JobsProcessor extends WorkerHost {
   ...
   * - Tools: throws retryable chunk failures back to BullMQ attempts/backoff.
